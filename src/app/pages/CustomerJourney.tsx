...
const phases: Phase[] = [
  ...
  },
  {
    id: "ticket-backlog",
    number: 6,
    title: "Ticket-Backlog-Abgleich",
    subtitle: "Jira, Asana, Azure Boards, … — Duplikate & Abhängigkeiten",
    ...
    actions: [
      "Backlog im verknüpften Ticket-Tool mit generierten Stories abgleichen",
